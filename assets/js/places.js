function initMap() {
  ...
  <div class="card-body places">
    ...
    <a href="https://www.viator.com/en-IE/Reykjavik-attractions/Vatnajokull-National-Park/d905-a11663" target="_blank" class="btn btn-outline-info">Viator</a>
    </div>
    </div>
  </div>
</div>`,
  ...
  <div class="card-body places">
    ...
    <a href="https://www.intrepidtravel.com/en/search?keyword=santorini&page=1&sort=relevance" target="_blank" class="btn btn-outline-info">Intrepid Travel</a>
    </div>
    </div>
  </div>
</div>`,
  ...
  <div class="card-body places">
    ...
    <a href="https://www.intrepidtravel.com/en/search?keyword=new+zealand&page=1&sort=relevance" target="_blank" class="btn btn-outline-info">Intrepid Travel</a>
    </div>
    </div>
  </div>
</div>`,
