function initMap(){
           ...
           let markers = [
           {coords:{lat:25.122318,lng:55.132433},
           content:'<h6>Palm Jumeirah in Dubai</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},
         
          {coords:{lat:36.176333,lng:-112.460353},
          content:'<h6>Grand Canyon</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

          {coords:{lat:-16.356378,lng:145.804226},
         content:'<h6>Great Barrier Reef</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:43.979102,lng:15.381623},
         content:'<h6>The Lovers Island</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},
               
         {coords:{lat: 43.077769,lng:-79.076075},
         content:'<h6>Niagara Falls</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:28.044935,lng:86.276308},
         content:'<h6>Mount Everest</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:23.993574,lng: -77.759123},
         content:'<h6>The Bahamas</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:70.492972,lng:-156.232523},
         content:'<h6>Alaska North Slopes</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:-32.023812,lng:135.370051},
         ...
         {coords:{lat:-20.20866,lng:-67.8721},
         ...
         {coords:{lat:-44.6230,lng:167.7842},
         ...
         {coords:{lat:47.5575,lng:10.74761},
         ...
         {coords:{lat:23.0664,lng:102.6968},
         ...
         {coords:{lat:44.5251,lng:-110.8403},
         ...
         {coords:{lat:63.61560,lng:-19.99069},
         ...
         {coords:{lat:-16.5979,lng:143.6004},
         ...
         {coords:{lat:-44.0084,lng:170.4555},
         ...
         {coords:{lat:43.80001,lng:6.04124},
         ...
         {coords:{lat:-34.0949,lng:123.1940},
         ...
         {coords:{lat:66.3407,lng:14.4945},
         ...
         {coords:{lat:38.9180,lng:100.3312},
         ...
         {coords:{lat:61.8989,lng:-7.514715},
         content:'<h6>Faroe Islands, Denmark</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:22.05209,lng:-159.68022},
         content:'<h6>Kauai, Hawaii</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>' },

         {coords:{lat:43.351702,lng:9.90800},
         content:'<h6>Tuscan Countryside, Italy</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:64.3816,lng:-17.25183},
         content:'<h6>Vatnajökull Ice Cave in Skaftafell National Park, Iceland</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:36.4072,lng:25.3505},
         content:'<h6>Santorini, Greece</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'},

         {coords:{lat:-38.2608,lng:175.1013},
         content:'<h6>Waitomo Glowworm Cave, New Zealand</h6><button id="maps"><a href="https://en.wikipedia.org/wiki/Palm_Jumeirah">Attractions</a></button>'}
