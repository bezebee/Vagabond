...
function initMap5() {
  ...
  for (i = 0; i < markers5.length; i++) {
    ...
    name = markers5[i].client_address;
...
function initMap6() {
  ...
  for (i = 0; i < markers6.length; i++) {
    ...
    name = markers6[i].client_address;
...
function initMap7() {
  ...
  for (i = 0; i < markers7.length; i++) {
    ...
    name = markers7[i].client_address;
...
function initMap8() {
  ...
  for (i = 0; i < markers8.length; i++) {
    ...
    name = markers8[i].client_address;
...
function initMap9() {
  ...
  for (i = 0; i < markers9.length; i++) {
    ...
    name = markers9[i].client_address;
...
function initMap10() {
  ...
  for (i = 0; i < markers10.length; i++) {
    ...
    name = markers10[i].client_address;
...
function initMap11() {
  ...
  for (i = 0; i < markers11.length; i++) {
    ...
    name = markers11[i].client_address;
...
function initMap12() {
  ...
  for (i = 0; i < markers12.length; i++) {
    ...
    name = markers12[i].client_address;
...
function initMap13() {
  ...
  for (i = 0; i < markers13.length; i++) {
    ...
    name = markers13[i].client_address;
